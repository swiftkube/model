...
private func dummyCronJob() -> batch.v1.CronJob {
	...
	return batch.v1.CronJob(metadata: meta.v1.ObjectMeta(
		creationTimestamp: Date(),
		deletionGracePeriodSeconds: 100,
		managedFields: [meta.v1.ManagedFieldsEntry](),
		name: "great-cronjob",
		namespace: "default",
		ownerReferences: [meta.v1.OwnerReference](),
		resourceVersion: "appv1",
		uid: "F3493650-A9DF-410F-B1A4-E8F5386E5B53"),
		spec: batch.v1.CronJobSpec(
