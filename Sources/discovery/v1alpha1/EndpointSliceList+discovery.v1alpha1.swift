...
public extension discovery.v1alpha1 {
	...
	struct EndpointSliceList: KubernetesResource, KubernetesResourceList {
		...
		typealias Resource = discovery.v1alpha1.EndpointSlice
		///
		...
		///
		let kind: String = "EndpointSliceList"
		...
		///
		var items: [discovery.v1alpha1.EndpointSlice]
...
extension discovery.v1alpha1.EndpointSliceList: Sequence {
	...
	public func makeIterator() -> AnyIterator<discovery.v1alpha1.EndpointSlice> {
