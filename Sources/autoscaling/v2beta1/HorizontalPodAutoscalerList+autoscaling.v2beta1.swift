...
public extension autoscaling.v2beta1 {
	...
	struct HorizontalPodAutoscalerList: KubernetesResource, KubernetesResourceList {
		...
		typealias Resource = autoscaling.v2beta1.HorizontalPodAutoscaler
		///
		...
		///
		let kind: String = "HorizontalPodAutoscalerList"
		...
		///
		var items: [autoscaling.v2beta1.HorizontalPodAutoscaler]
...
extension autoscaling.v2beta1.HorizontalPodAutoscalerList: Sequence {
	...
	public func makeIterator() -> AnyIterator<autoscaling.v2beta1.HorizontalPodAutoscaler> {
