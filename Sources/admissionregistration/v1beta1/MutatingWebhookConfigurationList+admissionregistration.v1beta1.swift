...
public extension admissionregistration.v1beta1 {
	...
	struct MutatingWebhookConfigurationList: KubernetesResource, KubernetesResourceList {
		...
		typealias Resource = admissionregistration.v1beta1.MutatingWebhookConfiguration
		///
		...
		///
		let kind: String = "MutatingWebhookConfigurationList"
		...
		///
		var items: [admissionregistration.v1beta1.MutatingWebhookConfiguration]
