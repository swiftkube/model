...
public extension scheduling.v1beta1 {
	...
	struct PriorityClassList: KubernetesResource, KubernetesResourceList {
		...
		typealias Resource = scheduling.v1beta1.PriorityClass
		///
		/// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
		///
		let apiVersion: String = "scheduling.k8s.io/v1beta1"
		...
		///
		var items: [scheduling.v1beta1.PriorityClass]
...
extension scheduling.v1beta1.PriorityClassList: Sequence {
	...
	public func makeIterator() -> AnyIterator<scheduling.v1beta1.PriorityClass> {
