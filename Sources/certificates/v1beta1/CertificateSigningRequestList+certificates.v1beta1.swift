...
public extension certificates.v1beta1 {
	...
	struct CertificateSigningRequestList: KubernetesResource, KubernetesResourceList {
		...
		typealias Resource = certificates.v1beta1.CertificateSigningRequest
		///
		...
		///
		let kind: String = "CertificateSigningRequestList"
		...
		/// No description
		///
		var items: [certificates.v1beta1.CertificateSigningRequest]
