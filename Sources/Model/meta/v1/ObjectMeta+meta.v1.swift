...
public extension meta.v1.ObjectMeta {
	...
	func encode(to encoder: Encoder) throws {
		...
		try container.encode(deletionGracePeriodSeconds, forKey: .deletionGracePeriodSeconds)
		try container.encode(deletionTimestamp, forKey: .deletionTimestamp)
		try container.encode(finalizers, forKey: .finalizers)
		try container.encode(generateName, forKey: .generateName)
		try container.encode(generation, forKey: .generation)
		try container.encode(labels, forKey: .labels)
		try container.encode(managedFields, forKey: .managedFields)
		try container.encode(name, forKey: .name)
		try container.encode(namespace, forKey: .namespace)
		try container.encode(ownerReferences, forKey: .ownerReferences)
