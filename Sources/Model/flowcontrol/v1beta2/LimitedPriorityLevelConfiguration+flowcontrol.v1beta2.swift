...
// MARK: - flowcontrol.v1beta2.LimitedPriorityLevelConfiguration
...
public extension flowcontrol.v1beta2 {
	...
	struct LimitedPriorityLevelConfiguration: KubernetesResource {
		...
		///
		public var limitResponse: flowcontrol.v1beta2.LimitResponse?
		///
		...
		public init(
			...
			limitResponse: flowcontrol.v1beta2.LimitResponse? = nil
		) {
...
/// Codable conformance
///
public extension flowcontrol.v1beta2.LimitedPriorityLevelConfiguration {
	...
	init(from decoder: Decoder) throws {
		...
		self.limitResponse = try container.decodeIfPresent(flowcontrol.v1beta2.LimitResponse.self, forKey: .limitResponse)
	}
