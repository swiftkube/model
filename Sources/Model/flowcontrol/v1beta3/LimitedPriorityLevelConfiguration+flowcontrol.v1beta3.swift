...
// MARK: - flowcontrol.v1beta3.LimitedPriorityLevelConfiguration
...
public extension flowcontrol.v1beta3 {
	...
	struct LimitedPriorityLevelConfiguration: KubernetesResource {
		...
		///
		public var limitResponse: flowcontrol.v1beta3.LimitResponse?
		///
		...
		public init(
			...
			limitResponse: flowcontrol.v1beta3.LimitResponse? = nil,
...
/// Codable conformance
///
public extension flowcontrol.v1beta3.LimitedPriorityLevelConfiguration {
	...
	init(from decoder: Decoder) throws {
		...
		self.limitResponse = try container.decodeIfPresent(flowcontrol.v1beta3.LimitResponse.self, forKey: .limitResponse)
