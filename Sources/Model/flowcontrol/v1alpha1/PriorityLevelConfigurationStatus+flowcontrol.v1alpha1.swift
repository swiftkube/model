...
/// Codable conformance
///
public extension flowcontrol.v1alpha1.PriorityLevelConfigurationStatus {
	...
	init(from decoder: Decoder) throws {
		...
		self.conditions = try container.decodeIfPresent([flowcontrol.v1alpha1.PriorityLevelConfigurationCondition].self, forKey: .conditions)
	}
