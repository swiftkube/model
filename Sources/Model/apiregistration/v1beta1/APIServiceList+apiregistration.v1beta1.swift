...
/// Codable conformance
///
public extension apiregistration.v1beta1.APIServiceList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([apiregistration.v1beta1.APIService].self, forKey: .items)
	}
...
// MARK: - apiregistration.v1beta1.APIServiceList + Sequence
