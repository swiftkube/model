...
public extension storage.v1 {
	...
	struct CSIDriverSpec: KubernetesResource {
		...
		///
		public var serviceAccountTokenInSecrets: Bool?
		///
		...
		public init(
			...
			serviceAccountTokenInSecrets: Bool? = nil,
			...
			self.serviceAccountTokenInSecrets = serviceAccountTokenInSecrets
...
public extension storage.v1.CSIDriverSpec {
	...
	private enum CodingKeys: String, CodingKey {
		...
		case serviceAccountTokenInSecrets = "serviceAccountTokenInSecrets"
	...
	init(from decoder: Decoder) throws {
		...
		self.serviceAccountTokenInSecrets = try container.decodeIfPresent(Bool.self, forKey: .serviceAccountTokenInSecrets)
	...
	func encode(to encoder: Encoder) throws {
		...
		try encodingContainer.encode(serviceAccountTokenInSecrets, forKey: .serviceAccountTokenInSecrets)
