...
/// Codable conformance
///
public extension storage.v1beta1.VolumeAttachmentStatus {
	...
	init(from decoder: Decoder) throws {
		...
		self.attachError = try container.decodeIfPresent(storage.v1beta1.VolumeError.self, forKey: .attachError)
		...
		self.detachError = try container.decodeIfPresent(storage.v1beta1.VolumeError.self, forKey: .detachError)
	}
