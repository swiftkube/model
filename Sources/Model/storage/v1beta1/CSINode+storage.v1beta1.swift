...
public extension storage.v1beta1 {
	...
	///
	struct CSINode: KubernetesResource, KubernetesAPIResource, MetadataHavingResource, ListableResource {
		///
		...
		///
		public static let listType: List.Type = storage.v1beta1.CSINodeList.self
		///
		/// APIVersion of this Kubernetes API Resource.
		///
		public static let apiVersion: APIVersion = .storageV1Beta1
		///
