...
public extension storage.v1beta1 {
	...
	struct VolumeAttachmentList: KubernetesResource, KubernetesResourceList {
		...
		///
		public typealias Item = storage.v1beta1.VolumeAttachment
		///
...
/// Codable conformance
///
public extension storage.v1beta1.VolumeAttachmentList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([storage.v1beta1.VolumeAttachment].self, forKey: .items)
	}
...
// MARK: - storage.v1beta1.VolumeAttachmentList + Sequence
