...
/// Codable conformance
///
public extension storage.v1beta1.CSINodeDriver {
	...
	init(from decoder: Decoder) throws {
		...
		self.allocatable = try container.decodeIfPresent(storage.v1beta1.VolumeNodeResources.self, forKey: .allocatable)
