...
public extension storage.v1beta1 {
	...
	struct CSIDriverSpec: KubernetesResource {
		...
		/// This is an alpha feature and only available when the CSIServiceAccountToken feature is enabled.
		///
		public var tokenRequests: [storage.v1beta1.TokenRequest]?
		///
		...
		public init(
			...
			tokenRequests: [storage.v1beta1.TokenRequest]? = nil,
...
public extension storage.v1beta1.CSIDriverSpec {
	...
	init(from decoder: Decoder) throws {
		...
		self.tokenRequests = try container.decodeIfPresent([storage.v1beta1.TokenRequest].self, forKey: .tokenRequests)
