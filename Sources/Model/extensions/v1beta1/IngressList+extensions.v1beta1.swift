...
/// Codable conformance
///
public extension extensions.v1beta1.IngressList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([extensions.v1beta1.Ingress].self, forKey: .items)
	}
...
// MARK: - extensions.v1beta1.IngressList + Sequence
