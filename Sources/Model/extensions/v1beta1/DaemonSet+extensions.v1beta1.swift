...
public extension extensions.v1beta1 {
	...
	///
	struct DaemonSet: KubernetesResource, ResourceWithMetadata {
		///
		...
		public init(
			...
			spec: extensions.v1beta1.DaemonSetSpec? = nil,
			status: extensions.v1beta1.DaemonSetStatus? = nil
		) {
...
/// Codable conformance
///
extension extensions.v1beta1.DaemonSet {
