...
public extension extensions.v1beta1 {
	...
	struct DeploymentStatus: KubernetesResource {
		...
		///
		public var conditions: [extensions.v1beta1.DeploymentCondition]?
		///
		...
		public init(
			...
			conditions: [extensions.v1beta1.DeploymentCondition]? = nil,
...
/// Codable conformance
///
extension extensions.v1beta1.DeploymentStatus {
