...
public extension extensions.v1beta1 {
	...
	struct ReplicaSetStatus: KubernetesResource {
		...
		///
		public var conditions: [extensions.v1beta1.ReplicaSetCondition]?
		///
		...
		public init(
			...
			conditions: [extensions.v1beta1.ReplicaSetCondition]? = nil,
...
/// Codable conformance
///
extension extensions.v1beta1.ReplicaSetStatus {
