...
// MARK: - autoscaling.v2beta1.ContainerResourceMetricSource
...
/// Codable conformance
///
public extension autoscaling.v2beta1.ContainerResourceMetricSource {
	...
	func encode(to encoder: Encoder) throws {
		...
		try encodingContainer.encode(targetAverageUtilization, forKey: .targetAverageUtilization)
