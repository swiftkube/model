...
// MARK: - autoscaling.v2beta1.HorizontalPodAutoscalerList
...
public extension autoscaling.v2beta1 {
	...
	struct HorizontalPodAutoscalerList: KubernetesResource, KubernetesResourceList {
		...
		///
		public typealias Item = autoscaling.v2beta1.HorizontalPodAutoscaler
		///
...
/// Codable conformance
///
public extension autoscaling.v2beta1.HorizontalPodAutoscalerList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([autoscaling.v2beta1.HorizontalPodAutoscaler].self, forKey: .items)
	}
...
// MARK: - autoscaling.v2beta1.HorizontalPodAutoscalerList + Sequence
