...
// MARK: - autoscaling.v2beta2.HorizontalPodAutoscalerStatus
...
public extension autoscaling.v2beta2 {
	...
	struct HorizontalPodAutoscalerStatus: KubernetesResource {
		...
		///
		public init(
			conditions: [autoscaling.v2beta2.HorizontalPodAutoscalerCondition]? = nil,
...
/// Codable conformance
///
public extension autoscaling.v2beta2.HorizontalPodAutoscalerStatus {
	...
	init(from decoder: Decoder) throws {
		...
		self.conditions = try container.decodeIfPresent([autoscaling.v2beta2.HorizontalPodAutoscalerCondition].self, forKey: .conditions)
