...
// MARK: - autoscaling.v2beta2.MetricSpec
...
public extension autoscaling.v2beta2 {
	...
	struct MetricSpec: KubernetesResource {
		...
		///
		public var containerResource: autoscaling.v2beta2.ContainerResourceMetricSource?
		///
		...
		///
		public init(
			containerResource: autoscaling.v2beta2.ContainerResourceMetricSource? = nil,
...
/// Codable conformance
///
public extension autoscaling.v2beta2.MetricSpec {
	...
	init(from decoder: Decoder) throws {
		...
		self.containerResource = try container.decodeIfPresent(autoscaling.v2beta2.ContainerResourceMetricSource.self, forKey: .containerResource)
