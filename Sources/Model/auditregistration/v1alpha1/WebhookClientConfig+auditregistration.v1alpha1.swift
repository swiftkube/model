...
/// Codable conformance
///
public extension auditregistration.v1alpha1.WebhookClientConfig {
	...
	init(from decoder: Decoder) throws {
		...
		self.service = try container.decodeIfPresent(auditregistration.v1alpha1.ServiceReference.self, forKey: .service)
