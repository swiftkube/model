...
// MARK: - batch.v1beta1.CronJobList
...
public extension batch.v1beta1 {
	...
	struct CronJobList: KubernetesResource, KubernetesResourceList {
		...
		///
		public typealias Item = batch.v1beta1.CronJob
		///
...
public extension batch.v1beta1.CronJobList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([batch.v1beta1.CronJob].self, forKey: .items)
	}
...
// MARK: - batch.v1beta1.CronJobList + Sequence
