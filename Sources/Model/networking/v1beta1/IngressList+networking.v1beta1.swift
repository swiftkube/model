...
public extension networking.v1beta1 {
	...
	struct IngressList: KubernetesResource, KubernetesResourceList {
		...
		///
		public typealias Item = networking.v1beta1.Ingress
		///
...
/// Codable conformance
///
public extension networking.v1beta1.IngressList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([networking.v1beta1.Ingress].self, forKey: .items)
	}
...
// MARK: - networking.v1beta1.IngressList + Sequence
