...
// MARK: - resource.v1alpha2.ResourceClaimSpec
...
public extension resource.v1alpha2 {
	...
	struct ResourceClaimSpec: KubernetesResource {
		...
		///
		public var parametersRef: resource.v1alpha2.ResourceClaimParametersReference?
		///
		...
		public init(
			...
			parametersRef: resource.v1alpha2.ResourceClaimParametersReference? = nil,
...
/// Codable conformance
///
public extension resource.v1alpha2.ResourceClaimSpec {
	...
	init(from decoder: Decoder) throws {
		...
		self.parametersRef = try container.decodeIfPresent(resource.v1alpha2.ResourceClaimParametersReference.self, forKey: .parametersRef)
