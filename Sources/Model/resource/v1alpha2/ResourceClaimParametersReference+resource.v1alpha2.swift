...
// MARK: - resource.v1alpha2.ResourceClaimParametersReference
...
public extension resource.v1alpha2 {
	...
	///
	struct ResourceClaimParametersReference: KubernetesResource {
		///
...
/// Codable conformance
///
public extension resource.v1alpha2.ResourceClaimParametersReference {
