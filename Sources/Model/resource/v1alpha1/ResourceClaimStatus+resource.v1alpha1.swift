...
// MARK: - resource.v1alpha1.ResourceClaimStatus
...
public extension resource.v1alpha1 {
	...
	struct ResourceClaimStatus: KubernetesResource {
		...
		///
		public var allocation: resource.v1alpha1.AllocationResult?
		///
		...
		///
		public var reservedFor: [resource.v1alpha1.ResourceClaimConsumerReference]?
		///
		/// Default memberwise initializer
		///
		public init(
			allocation: resource.v1alpha1.AllocationResult? = nil,
			deallocationRequested: Bool? = nil,
			driverName: String? = nil,
			reservedFor: [resource.v1alpha1.ResourceClaimConsumerReference]? = nil
		) {
...
/// Codable conformance
///
public extension resource.v1alpha1.ResourceClaimStatus {
	...
	init(from decoder: Decoder) throws {
		...
		self.allocation = try container.decodeIfPresent(resource.v1alpha1.AllocationResult.self, forKey: .allocation)
		...
		self.reservedFor = try container.decodeIfPresent([resource.v1alpha1.ResourceClaimConsumerReference].self, forKey: .reservedFor)
	}
