...
// MARK: - resource.v1alpha1.ResourceClass
...
public extension resource.v1alpha1 {
		...
		ReadableResource, ListableResource, CreatableResource, ReplaceableResource, DeletableResource, CollectionDeletableResource
	{
		...
		///
		public typealias List = resource.v1alpha1.ResourceClassList
		///
		...
		///
		public var parametersRef: resource.v1alpha1.ResourceClassParametersReference?
		///
		...
		public init(
			...
			driverName: String,
			parametersRef: resource.v1alpha1.ResourceClassParametersReference? = nil,
...
/// Codable conformance
///
public extension resource.v1alpha1.ResourceClass {
	...
	init(from decoder: Decoder) throws {
		...
		self.parametersRef = try container.decodeIfPresent(resource.v1alpha1.ResourceClassParametersReference.self, forKey: .parametersRef)
