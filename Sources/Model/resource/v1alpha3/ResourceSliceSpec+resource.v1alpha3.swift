...
public extension resource.v1alpha3 {
	...
	struct ResourceSliceSpec: KubernetesResource {
		...
		///
		public var sharedCounters: [resource.v1alpha3.CounterSet]?
		///
		...
		public init(
			...
			sharedCounters: [resource.v1alpha3.CounterSet]? = nil
		) {
...
public extension resource.v1alpha3.ResourceSliceSpec {
	...
	init(from decoder: Decoder) throws {
		...
		self.sharedCounters = try container.decodeIfPresent([resource.v1alpha3.CounterSet].self, forKey: .sharedCounters)
	}
