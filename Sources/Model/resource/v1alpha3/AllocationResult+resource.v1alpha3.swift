...
// MARK: - resource.v1alpha3.AllocationResult
...
public extension resource.v1alpha3 {
	...
	struct AllocationResult: KubernetesResource {
		...
		///
		public var devices: resource.v1alpha3.DeviceAllocationResult?
		///
		...
		///
		public init(
			devices: resource.v1alpha3.DeviceAllocationResult? = nil,
...
/// Codable conformance
///
public extension resource.v1alpha3.AllocationResult {
	...
	init(from decoder: Decoder) throws {
		...
		self.devices = try container.decodeIfPresent(resource.v1alpha3.DeviceAllocationResult.self, forKey: .devices)
