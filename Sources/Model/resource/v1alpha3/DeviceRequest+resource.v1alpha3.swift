...
// MARK: - resource.v1alpha3.DeviceRequest
...
public extension resource.v1alpha3 {
	...
	struct DeviceRequest: KubernetesResource {
		...
		///
		public var firstAvailable: [resource.v1alpha3.DeviceSubRequest]?
		///
		...
		///
		public var tolerations: [resource.v1alpha3.DeviceToleration]?
		///
		...
		public init(
			...
			firstAvailable: [resource.v1alpha3.DeviceSubRequest]? = nil,
			name: String,
			selectors: [resource.v1alpha3.DeviceSelector]? = nil,
			tolerations: [resource.v1alpha3.DeviceToleration]? = nil
		) {
...
/// Codable conformance
///
public extension resource.v1alpha3.DeviceRequest {
	...
	init(from decoder: Decoder) throws {
		...
		self.firstAvailable = try container.decodeIfPresent([resource.v1alpha3.DeviceSubRequest].self, forKey: .firstAvailable)
		self.name = try container.decode(String.self, forKey: .name)
		self.selectors = try container.decodeIfPresent([resource.v1alpha3.DeviceSelector].self, forKey: .selectors)
		self.tolerations = try container.decodeIfPresent([resource.v1alpha3.DeviceToleration].self, forKey: .tolerations)
	}
