...
// MARK: - resource.v1alpha3.DeviceClassSpec
...
public extension resource.v1alpha3 {
	...
	struct DeviceClassSpec: KubernetesResource {
		...
		///
		public var config: [resource.v1alpha3.DeviceClassConfiguration]?
		///
		...
		///
		public init(
			config: [resource.v1alpha3.DeviceClassConfiguration]? = nil,
...
/// Codable conformance
///
public extension resource.v1alpha3.DeviceClassSpec {
	...
	init(from decoder: Decoder) throws {
		...
		self.config = try container.decodeIfPresent([resource.v1alpha3.DeviceClassConfiguration].self, forKey: .config)
