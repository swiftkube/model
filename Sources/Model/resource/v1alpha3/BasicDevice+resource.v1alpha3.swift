...
public extension resource.v1alpha3 {
	...
	struct BasicDevice: KubernetesResource {
		...
		///
		public var consumesCounters: [resource.v1alpha3.DeviceCounterConsumption]?
		///
		...
		///
		public var taints: [resource.v1alpha3.DeviceTaint]?
		///
		...
		public init(
			...
			consumesCounters: [resource.v1alpha3.DeviceCounterConsumption]? = nil,
			nodeName: String? = nil,
			nodeSelector: core.v1.NodeSelector? = nil,
			taints: [resource.v1alpha3.DeviceTaint]? = nil
		) {
...
public extension resource.v1alpha3.BasicDevice {
	...
	init(from decoder: Decoder) throws {
		...
		self.consumesCounters = try container.decodeIfPresent([resource.v1alpha3.DeviceCounterConsumption].self, forKey: .consumesCounters)
		...
		self.taints = try container.decodeIfPresent([resource.v1alpha3.DeviceTaint].self, forKey: .taints)
	}
