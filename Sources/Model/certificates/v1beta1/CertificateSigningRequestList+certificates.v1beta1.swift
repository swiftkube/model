...
public extension certificates.v1beta1 {
	...
	struct CertificateSigningRequestList: KubernetesResource, KubernetesResourceList {
		...
		///
		public typealias Item = certificates.v1beta1.CertificateSigningRequest
		///
...
/// Codable conformance
///
public extension certificates.v1beta1.CertificateSigningRequestList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([certificates.v1beta1.CertificateSigningRequest].self, forKey: .items)
	}
...
// MARK: - certificates.v1beta1.CertificateSigningRequestList + Sequence
