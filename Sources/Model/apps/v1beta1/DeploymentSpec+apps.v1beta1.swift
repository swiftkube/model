...
public extension apps.v1beta1 {
	...
	struct DeploymentSpec: KubernetesResource {
		...
		///
		public var rollbackTo: apps.v1beta1.RollbackConfig?
		///
		...
		///
		public var strategy: apps.v1beta1.DeploymentStrategy?
		///
		...
		public init(
			...
			rollbackTo: apps.v1beta1.RollbackConfig? = nil,
			selector: meta.v1.LabelSelector? = nil,
			strategy: apps.v1beta1.DeploymentStrategy? = nil,
...
/// Codable conformance
///
extension apps.v1beta1.DeploymentSpec {
