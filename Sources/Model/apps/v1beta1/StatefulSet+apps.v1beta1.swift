...
public extension apps.v1beta1 {
	...
	struct StatefulSet: KubernetesResource, ResourceWithMetadata {
		...
		///
		public var spec: apps.v1beta1.StatefulSetSpec?
		///
		/// Status is the current status of Pods in this StatefulSet. This data may be out of date by some window of time.
		///
		public var status: apps.v1beta1.StatefulSetStatus?
		///
		/// Default memberwise initializer
		///
		public init(
			metadata: meta.v1.ObjectMeta? = nil,
			spec: apps.v1beta1.StatefulSetSpec? = nil,
			status: apps.v1beta1.StatefulSetStatus? = nil
		) {
