...
/// Codable conformance
///
public extension apiextensions.v1beta1.WebhookClientConfig {
	...
	init(from decoder: Decoder) throws {
		...
		self.service = try container.decodeIfPresent(apiextensions.v1beta1.ServiceReference.self, forKey: .service)
