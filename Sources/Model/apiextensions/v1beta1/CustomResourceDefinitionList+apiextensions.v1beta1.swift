...
/// Codable conformance
///
public extension apiextensions.v1beta1.CustomResourceDefinitionList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([apiextensions.v1beta1.CustomResourceDefinition].self, forKey: .items)
	}
...
// MARK: - apiextensions.v1beta1.CustomResourceDefinitionList + Sequence
