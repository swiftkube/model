...
// MARK: - node.v1beta1.RuntimeClassList
...
public extension node.v1beta1 {
	...
	struct RuntimeClassList: KubernetesResource, KubernetesResourceList {
		...
		///
		public typealias Item = node.v1beta1.RuntimeClass
		///
...
/// Codable conformance
///
public extension node.v1beta1.RuntimeClassList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([node.v1beta1.RuntimeClass].self, forKey: .items)
	}
...
// MARK: - node.v1beta1.RuntimeClassList + Sequence
