...
public extension GroupVersionKind {
	...
	static let resourceV1Alpha3DeviceClass = GroupVersionKind(group: "resource.k8s.io", version: "v1alpha3", kind: "DeviceClass")
	static let resourceV1Alpha3ResourceClaim = GroupVersionKind(group: "resource.k8s.io", version: "v1alpha3", kind: "ResourceClaim")
	static let resourceV1Alpha3ResourceClaimTemplate = GroupVersionKind(group: "resource.k8s.io", version: "v1alpha3", kind: "ResourceClaimTemplate")
	static let resourceV1Alpha3ResourceSlice = GroupVersionKind(group: "resource.k8s.io", version: "v1alpha3", kind: "ResourceSlice")
