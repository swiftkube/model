...
public extension GroupVersionKind {
	...
	static let certificatesV1Beta1PodCertificateRequest = GroupVersionKind(group: "certificates.k8s.io", version: "v1beta1", kind: "PodCertificateRequest")
	...
	static let schedulingV1Alpha1Workload = GroupVersionKind(group: "scheduling.k8s.io", version: "v1alpha1", kind: "Workload")
	...
	static let storagemigrationV1Beta1StorageVersionMigration = GroupVersionKind(group: "storagemigration.k8s.io", version: "v1beta1", kind: "StorageVersionMigration")
}
