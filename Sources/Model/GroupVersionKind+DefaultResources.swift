...
public extension GroupVersionKind {
	...
	static let autoscalingV2Beta1HorizontalPodAutoscaler = GroupVersionKind(group: "autoscaling", version: "v2beta1", kind: "HorizontalPodAutoscaler")
	...
	static let batchV1Beta1CronJob = GroupVersionKind(group: "batch", version: "v1beta1", kind: "CronJob")
	...
	static let discoveryV1Beta1EndpointSlice = GroupVersionKind(group: "discovery.k8s.io", version: "v1beta1", kind: "EndpointSlice")
	static let eventsV1Event = GroupVersionKind(group: "events.k8s.io", version: "v1", kind: "Event")
	static let eventsV1Beta1Event = GroupVersionKind(group: "events.k8s.io", version: "v1beta1", kind: "Event")
	...
	static let nodeV1Beta1RuntimeClass = GroupVersionKind(group: "node.k8s.io", version: "v1beta1", kind: "RuntimeClass")
	static let nodeV1Alpha1RuntimeClass = GroupVersionKind(group: "node.k8s.io", version: "v1alpha1", kind: "RuntimeClass")
	static let policyV1PodDisruptionBudget = GroupVersionKind(group: "policy", version: "v1", kind: "PodDisruptionBudget")
	static let policyV1Beta1PodDisruptionBudget = GroupVersionKind(group: "policy", version: "v1beta1", kind: "PodDisruptionBudget")
	static let policyV1Beta1PodSecurityPolicy = GroupVersionKind(group: "policy", version: "v1beta1", kind: "PodSecurityPolicy")
	...
	static let rbacV1Alpha1ClusterRole = GroupVersionKind(group: "rbac.authorization.k8s.io", version: "v1alpha1", kind: "ClusterRole")
	static let rbacV1Alpha1ClusterRoleBinding = GroupVersionKind(group: "rbac.authorization.k8s.io", version: "v1alpha1", kind: "ClusterRoleBinding")
	static let rbacV1Alpha1Role = GroupVersionKind(group: "rbac.authorization.k8s.io", version: "v1alpha1", kind: "Role")
	static let rbacV1Alpha1RoleBinding = GroupVersionKind(group: "rbac.authorization.k8s.io", version: "v1alpha1", kind: "RoleBinding")
	static let schedulingV1PriorityClass = GroupVersionKind(group: "scheduling.k8s.io", version: "v1", kind: "PriorityClass")
	static let schedulingV1Alpha1PriorityClass = GroupVersionKind(group: "scheduling.k8s.io", version: "v1alpha1", kind: "PriorityClass")
	...
	static let storageV1Alpha1CSIStorageCapacity = GroupVersionKind(group: "storage.k8s.io", version: "v1alpha1", kind: "CSIStorageCapacity")
	static let storageV1Alpha1VolumeAttachment = GroupVersionKind(group: "storage.k8s.io", version: "v1alpha1", kind: "VolumeAttachment")
}
