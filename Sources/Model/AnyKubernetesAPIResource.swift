...
public struct AnyKubernetesAPIResource: KubernetesAPIResource {
	...
	public init(from decoder: Decoder) throws {
		...
		case GroupVersionKind.admissionregistrationV1Beta1MutatingWebhookConfiguration:
			decoded = try admissionregistration.v1beta1.MutatingWebhookConfiguration(from: decoder)
		case GroupVersionKind.admissionregistrationV1Beta1ValidatingWebhookConfiguration:
		...
		case GroupVersionKind.apiextensionsV1Beta1CustomResourceDefinition:
		...
		case GroupVersionKind.apiregistrationV1Beta1APIService:
		...
		case GroupVersionKind.authenticationV1Beta1TokenReview:
		...
		case GroupVersionKind.authorizationV1Beta1LocalSubjectAccessReview:
			decoded = try authorization.v1beta1.LocalSubjectAccessReview(from: decoder)
		case GroupVersionKind.authorizationV1Beta1SelfSubjectAccessReview:
			decoded = try authorization.v1beta1.SelfSubjectAccessReview(from: decoder)
		case GroupVersionKind.authorizationV1Beta1SelfSubjectRulesReview:
			decoded = try authorization.v1beta1.SelfSubjectRulesReview(from: decoder)
		case GroupVersionKind.authorizationV1Beta1SubjectAccessReview:
		...
		case GroupVersionKind.batchV2Alpha1CronJob:
		...
		case GroupVersionKind.certificatesV1Beta1CertificateSigningRequest:
		...
		case GroupVersionKind.coordinationV1Beta1Lease:
		...
		case GroupVersionKind.extensionsV1Beta1Ingress:
		...
		case GroupVersionKind.flowcontrolV1Alpha1FlowSchema:
			decoded = try flowcontrol.v1alpha1.FlowSchema(from: decoder)
		case GroupVersionKind.flowcontrolV1Alpha1PriorityLevelConfiguration:
		...
		case GroupVersionKind.networkingV1Beta1Ingress:
			decoded = try networking.v1beta1.Ingress(from: decoder)
		case GroupVersionKind.networkingV1Beta1IngressClass:
		...
		case GroupVersionKind.rbacV1Beta1ClusterRole:
			decoded = try rbac.v1beta1.ClusterRole(from: decoder)
		case GroupVersionKind.rbacV1Beta1ClusterRoleBinding:
			decoded = try rbac.v1beta1.ClusterRoleBinding(from: decoder)
		case GroupVersionKind.rbacV1Beta1Role:
			decoded = try rbac.v1beta1.Role(from: decoder)
		case GroupVersionKind.rbacV1Beta1RoleBinding:
		...
		case GroupVersionKind.schedulingV1Beta1PriorityClass:
		...
		case GroupVersionKind.storageV1Beta1CSIDriver:
			decoded = try storage.v1beta1.CSIDriver(from: decoder)
		case GroupVersionKind.storageV1Beta1CSINode:
			decoded = try storage.v1beta1.CSINode(from: decoder)
		case GroupVersionKind.storageV1Beta1StorageClass:
			decoded = try storage.v1beta1.StorageClass(from: decoder)
		case GroupVersionKind.storageV1Beta1VolumeAttachment:
