...
public extension GroupVersionResource {
	...
	private static func tryKind(_ kind: String) -> GroupVersionResource? {
		...
		case "podcertificaterequest":
			return GroupVersionResource(group: "certificates.k8s.io", version: "v1beta1", resource: "podcertificaterequests")
		case "lease":
		...
		case "workload":
			return GroupVersionResource(group: "scheduling.k8s.io", version: "v1alpha1", resource: "workloads")
		case "csidriver":
		...
		case "storageversionmigration":
			return GroupVersionResource(group: "storagemigration.k8s.io", version: "v1beta1", resource: "storageversionmigrations")
		default:
			return nil
		}
	}
