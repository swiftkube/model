...
public extension GroupVersionResource {
	...
	private static func tryKind(_ kind: String) -> GroupVersionResource? {
		...
		case "validatingadmissionpolicy":
			return GroupVersionResource(group: "admissionregistration.k8s.io", version: "v1beta1", resource: "validatingadmissionpolicies")
		case "validatingadmissionpolicybinding":
			return GroupVersionResource(group: "admissionregistration.k8s.io", version: "v1beta1", resource: "validatingadmissionpolicybindings")
		...
		case "clustertrustbundle":
			return GroupVersionResource(group: "certificates.k8s.io", version: "v1alpha1", resource: "clustertrusubundles")
		case "lease":
		...
		case "flowschema":
			return GroupVersionResource(group: "flowcontrol.apiserver.k8s.io", version: "v1beta3", resource: "flowschemas")
		case "prioritylevelconfiguration":
			return GroupVersionResource(group: "flowcontrol.apiserver.k8s.io", version: "v1beta3", resource: "prioritylevelconfigurations")
		case "storageversion":
		...
		case "clustercidr":
			return GroupVersionResource(group: "networking.k8s.io", version: "v1alpha1", resource: "clustercidrs")
		case "ipaddress":
			return GroupVersionResource(group: "networking.k8s.io", version: "v1alpha1", resource: "ipaddresses")
		case "runtimeclass":
		...
		case "podschedulingcontext":
			return GroupVersionResource(group: "resource.k8s.io", version: "v1alpha2", resource: "podschedulingcontexts")
		case "resourceclaim":
			return GroupVersionResource(group: "resource.k8s.io", version: "v1alpha2", resource: "resourceclaims")
		case "resourceclaimtemplate":
			return GroupVersionResource(group: "resource.k8s.io", version: "v1alpha2", resource: "resourceclaimtemplates")
		case "resourceclass":
			return GroupVersionResource(group: "resource.k8s.io", version: "v1alpha2", resource: "resourceclasses")
		case "priorityclass":
