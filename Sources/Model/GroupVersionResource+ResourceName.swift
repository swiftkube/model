...
extension GroupVersionResource {
	...
	private static func tryKind(_ kind: String) -> GroupVersionResource? {
		...
		case "flowschema":
			return GroupVersionResource(group: "flowcontrol.apiserver.k8s.io", version: "v1beta1", resource: "flowschemas")
		case "prioritylevelconfiguration":
			return GroupVersionResource(group: "flowcontrol.apiserver.k8s.io", version: "v1beta1", resource: "prioritylevelconfigurations")
		case "storageversion":
		...
		case "podsecuritypolicy":
			return GroupVersionResource(group: "policy", version: "v1beta1", resource: "podsecuritypolicies")
		case "clusterrole":
		...
		case "csistoragecapacity":
			return GroupVersionResource(group: "storage.k8s.io", version: "v1beta1", resource: "csistoragecapacities")
		default:
			return nil
		}
	}
