...
public extension GroupVersionResource {
	...
	private static func tryKind(_ kind: String) -> GroupVersionResource? {
		...
		case "flowschema":
			return GroupVersionResource(group: "flowcontrol.apiserver.k8s.io", version: "v1beta2", resource: "flowschemas")
		case "prioritylevelconfiguration":
			return GroupVersionResource(group: "flowcontrol.apiserver.k8s.io", version: "v1beta2", resource: "prioritylevelconfigurations")
		case "storageversion":
