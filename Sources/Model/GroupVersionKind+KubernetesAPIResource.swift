...
public extension GroupVersionKind {
	...
	init?<R: KubernetesAPIResource>(of type: R.Type) {
		...
		case is certificates.v1beta1.PodCertificateRequest.Type:
			self = .certificatesV1Beta1PodCertificateRequest
		...
		case is scheduling.v1alpha1.Workload.Type:
			self = .schedulingV1Alpha1Workload
		...
		case is storagemigration.v1beta1.StorageVersionMigration.Type:
			self = .storagemigrationV1Beta1StorageVersionMigration
		default:
			return nil
		}
	}
