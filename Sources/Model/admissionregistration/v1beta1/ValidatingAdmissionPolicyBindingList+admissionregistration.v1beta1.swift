...
// MARK: - admissionregistration.v1beta1.ValidatingAdmissionPolicyBindingList
...
public extension admissionregistration.v1beta1 {
	...
	struct ValidatingAdmissionPolicyBindingList: KubernetesResource, KubernetesResourceList {
		...
		///
		public typealias Item = admissionregistration.v1beta1.ValidatingAdmissionPolicyBinding
		///
...
/// Codable conformance
///
public extension admissionregistration.v1beta1.ValidatingAdmissionPolicyBindingList {
...
// MARK: - admissionregistration.v1beta1.ValidatingAdmissionPolicyBindingList + Sequence

///
/// Sequence iterator for KubernetesResourceList items
///
extension admissionregistration.v1beta1.ValidatingAdmissionPolicyBindingList: Sequence {

	public typealias Element = admissionregistration.v1beta1.ValidatingAdmissionPolicyBinding

	public func makeIterator() -> AnyIterator<admissionregistration.v1beta1.ValidatingAdmissionPolicyBinding> {
