...
/// Codable conformance
///
public extension admissionregistration.v1beta1.WebhookClientConfig {
	...
	init(from decoder: Decoder) throws {
		...
		self.service = try container.decodeIfPresent(admissionregistration.v1beta1.ServiceReference.self, forKey: .service)
