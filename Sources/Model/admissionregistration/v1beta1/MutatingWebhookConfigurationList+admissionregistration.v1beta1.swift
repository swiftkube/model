...
public extension admissionregistration.v1beta1 {
	...
	struct MutatingWebhookConfigurationList: KubernetesResource, KubernetesResourceList {
		...
		///
		public typealias Item = admissionregistration.v1beta1.MutatingWebhookConfiguration
		///
...
/// Codable conformance
///
public extension admissionregistration.v1beta1.MutatingWebhookConfigurationList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([admissionregistration.v1beta1.MutatingWebhookConfiguration].self, forKey: .items)
	}
...
// MARK: - admissionregistration.v1beta1.MutatingWebhookConfigurationList + Sequence
