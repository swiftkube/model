...
public extension admissionregistration.v1alpha1 {
	...
	struct ValidatingAdmissionPolicySpec: KubernetesResource {
		...
		///
		public var auditAnnotations: [admissionregistration.v1alpha1.AuditAnnotation]?
		///
		...
		///
		public init(
			auditAnnotations: [admissionregistration.v1alpha1.AuditAnnotation]? = nil,
			...
			validations: [admissionregistration.v1alpha1.Validation]? = nil,
...
public extension admissionregistration.v1alpha1.ValidatingAdmissionPolicySpec {
	...
	init(from decoder: Decoder) throws {
		...
		self.auditAnnotations = try container.decodeIfPresent([admissionregistration.v1alpha1.AuditAnnotation].self, forKey: .auditAnnotations)
		...
		self.validations = try container.decodeIfPresent([admissionregistration.v1alpha1.Validation].self, forKey: .validations)
