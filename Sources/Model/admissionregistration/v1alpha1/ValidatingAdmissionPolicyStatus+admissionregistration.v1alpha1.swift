...
// MARK: - admissionregistration.v1alpha1.ValidatingAdmissionPolicyStatus
...
public extension admissionregistration.v1alpha1 {
	...
	struct ValidatingAdmissionPolicyStatus: KubernetesResource {
		...
		///
		public var typeChecking: admissionregistration.v1alpha1.TypeChecking?
		///
		...
		public init(
			...
			typeChecking: admissionregistration.v1alpha1.TypeChecking? = nil
		) {
...
/// Codable conformance
///
public extension admissionregistration.v1alpha1.ValidatingAdmissionPolicyStatus {
	...
	init(from decoder: Decoder) throws {
		...
		self.typeChecking = try container.decodeIfPresent(admissionregistration.v1alpha1.TypeChecking.self, forKey: .typeChecking)
	}
