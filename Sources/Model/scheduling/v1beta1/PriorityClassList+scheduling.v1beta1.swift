...
public extension scheduling.v1beta1 {
	...
	struct PriorityClassList: KubernetesResource, KubernetesResourceList {
		...
		///
		public typealias Item = scheduling.v1beta1.PriorityClass
		///
...
/// Codable conformance
///
public extension scheduling.v1beta1.PriorityClassList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([scheduling.v1beta1.PriorityClass].self, forKey: .items)
	}
...
// MARK: - scheduling.v1beta1.PriorityClassList + Sequence
