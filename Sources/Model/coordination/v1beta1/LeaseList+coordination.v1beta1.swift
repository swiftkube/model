...
public extension coordination.v1beta1 {
	...
	struct LeaseList: KubernetesResource, KubernetesResourceList {
		...
		///
		public typealias Item = coordination.v1beta1.Lease
		///
...
/// Codable conformance
///
public extension coordination.v1beta1.LeaseList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([coordination.v1beta1.Lease].self, forKey: .items)
	}
...
// MARK: - coordination.v1beta1.LeaseList + Sequence
