...
public extension GroupVersionKind {
	...
	private static func tryKind(_ kind: String) -> GroupVersionKind? {
		...
		case "podcertificaterequest":
			return GroupVersionKind.certificatesV1Beta1PodCertificateRequest
		case "lease":
		...
		case "workload":
			return GroupVersionKind.schedulingV1Alpha1Workload
		case "csidriver":
		...
		case "storageversionmigration":
			return GroupVersionKind.storagemigrationV1Beta1StorageVersionMigration
		default:
			return nil
		}
	}
