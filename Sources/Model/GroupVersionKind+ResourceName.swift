...
extension GroupVersionKind {
	...
	private static func tryKind(_ kind: String) -> GroupVersionKind? {
		...
		case "flowschema":
			return GroupVersionKind.flowcontrolV1Beta1FlowSchema
		case "prioritylevelconfiguration":
			return GroupVersionKind.flowcontrolV1Beta1PriorityLevelConfiguration
		case "storageversion":
		...
		case "podsecuritypolicy":
			return GroupVersionKind.policyV1Beta1PodSecurityPolicy
		case "clusterrole":
		...
		case "csistoragecapacity":
			return GroupVersionKind.storageV1Beta1CSIStorageCapacity
		default:
			return nil
		}
	}
