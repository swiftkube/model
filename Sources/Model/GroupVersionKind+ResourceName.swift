...
public extension GroupVersionKind {
	...
	private static func tryKind(_ kind: String) -> GroupVersionKind? {
		...
		case "mutatingadmissionpolicy":
			return GroupVersionKind.admissionregistrationV1Alpha1MutatingAdmissionPolicy
		case "mutatingadmissionpolicybinding":
			return GroupVersionKind.admissionregistrationV1Alpha1MutatingAdmissionPolicyBinding
		...
		case "leasecandidate":
			return GroupVersionKind.coordinationV1Alpha2LeaseCandidate
		case "endpointslice":
		...
		case "ipaddress":
			return GroupVersionKind.networkingV1Beta1IPAddress
		case "servicecidr":
			return GroupVersionKind.networkingV1Beta1ServiceCIDR
		case "runtimeclass":
		...
		case "deviceclass":
			return GroupVersionKind.resourceV1Beta1DeviceClass
		case "resourceclaim":
			return GroupVersionKind.resourceV1Beta1ResourceClaim
		case "resourceclaimtemplate":
			return GroupVersionKind.resourceV1Beta1ResourceClaimTemplate
		case "resourceslice":
			return GroupVersionKind.resourceV1Beta1ResourceSlice
		case "priorityclass":
