...
public extension GroupVersionKind {
	...
	private static func tryKind(_ kind: String) -> GroupVersionKind? {
		...
		case "deviceclass":
			return GroupVersionKind.resourceV1Beta2DeviceClass
		case "resourceclaim":
			return GroupVersionKind.resourceV1Beta2ResourceClaim
		case "resourceclaimtemplate":
			return GroupVersionKind.resourceV1Beta2ResourceClaimTemplate
		case "resourceslice":
			return GroupVersionKind.resourceV1Beta2ResourceSlice
