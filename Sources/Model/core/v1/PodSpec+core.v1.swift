...
public extension core.v1 {
	...
	struct PodSpec: KubernetesResource {
		...
		///
		public var workloadRef: core.v1.WorkloadReference?
		///
		...
		public init(
			...
			workloadRef: core.v1.WorkloadReference? = nil
		) {
...
public extension core.v1.PodSpec {
	...
	init(from decoder: Decoder) throws {
		...
		self.workloadRef = try container.decodeIfPresent(core.v1.WorkloadReference.self, forKey: .workloadRef)
	}
	...
	func encode(to encoder: Encoder) throws {
		...
		try encodingContainer.encode(workloadRef, forKey: .workloadRef)
	}
}
