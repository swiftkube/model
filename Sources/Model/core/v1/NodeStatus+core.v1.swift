...
public extension core.v1.NodeStatus {
	...
	init(from decoder: Decoder) throws {
		...
		self.declaredFeatures = try container.decodeIfPresent([String].self, forKey: .declaredFeatures)
	...
	func encode(to encoder: Encoder) throws {
		...
		try encodingContainer.encode(declaredFeatures, forKey: .declaredFeatures)
