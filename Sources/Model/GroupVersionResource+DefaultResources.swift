...
public extension GroupVersionResource {
	...
	static let certificatesV1Beta1PodCertificateRequest = GroupVersionResource(group: "certificates.k8s.io", version: "v1beta1", resource: "podcertificaterequests")
	...
	static let schedulingV1Alpha1Workload = GroupVersionResource(group: "scheduling.k8s.io", version: "v1alpha1", resource: "workloads")
	...
	static let storagemigrationV1Beta1StorageVersionMigration = GroupVersionResource(group: "storagemigration.k8s.io", version: "v1beta1", resource: "storageversionmigrations")
}
