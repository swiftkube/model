...
public extension GroupVersionResource {
	...
	static let resourceV1Alpha3DeviceClass = GroupVersionResource(group: "resource.k8s.io", version: "v1alpha3", resource: "deviceclasses")
	static let resourceV1Alpha3ResourceClaim = GroupVersionResource(group: "resource.k8s.io", version: "v1alpha3", resource: "resourceclaims")
	static let resourceV1Alpha3ResourceClaimTemplate = GroupVersionResource(group: "resource.k8s.io", version: "v1alpha3", resource: "resourceclaimtemplates")
	static let resourceV1Alpha3ResourceSlice = GroupVersionResource(group: "resource.k8s.io", version: "v1alpha3", resource: "resourceslices")
