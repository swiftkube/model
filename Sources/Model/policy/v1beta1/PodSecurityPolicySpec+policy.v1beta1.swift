...
// MARK: - policy.v1beta1.PodSecurityPolicySpec
...
public extension policy.v1beta1.PodSecurityPolicySpec {
	...
	func encode(to encoder: Encoder) throws {
		...
		try encodingContainer.encode(allowedCSIDrivers, forKey: .allowedCSIDrivers)
		try encodingContainer.encode(allowedCapabilities, forKey: .allowedCapabilities)
		try encodingContainer.encode(allowedFlexVolumes, forKey: .allowedFlexVolumes)
		try encodingContainer.encode(allowedHostPaths, forKey: .allowedHostPaths)
		try encodingContainer.encode(allowedProcMountTypes, forKey: .allowedProcMountTypes)
		try encodingContainer.encode(allowedUnsafeSysctls, forKey: .allowedUnsafeSysctls)
		try encodingContainer.encode(defaultAddCapabilities, forKey: .defaultAddCapabilities)
		try encodingContainer.encode(defaultAllowPrivilegeEscalation, forKey: .defaultAllowPrivilegeEscalation)
		try encodingContainer.encode(forbiddenSysctls, forKey: .forbiddenSysctls)
		...
		try encodingContainer.encode(hostPorts, forKey: .hostPorts)
		...
		try encodingContainer.encode(requiredDropCapabilities, forKey: .requiredDropCapabilities)
		try encodingContainer.encode(runAsGroup, forKey: .runAsGroup)
		try encodingContainer.encode(runAsUser, forKey: .runAsUser)
		try encodingContainer.encode(runtimeClass, forKey: .runtimeClass)
		try encodingContainer.encode(seLinux, forKey: .seLinux)
