...
public extension rbac.v1beta1 {
	...
	struct ClusterRoleList: KubernetesResource, KubernetesResourceList {
		...
		///
		public typealias Item = rbac.v1beta1.ClusterRole
		///
...
/// Codable conformance
///
public extension rbac.v1beta1.ClusterRoleList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([rbac.v1beta1.ClusterRole].self, forKey: .items)
	}
...
// MARK: - rbac.v1beta1.ClusterRoleList + Sequence
