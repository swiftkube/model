...
/// Codable conformance
///
public extension rbac.v1beta1.RoleBindingList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([rbac.v1beta1.RoleBinding].self, forKey: .items)
	}
...
// MARK: - rbac.v1beta1.RoleBindingList + Sequence
