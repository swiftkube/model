...
public extension rbac.v1alpha1 {
	...
	struct RoleList: KubernetesResource, KubernetesResourceList {
		...
		///
		public typealias Item = rbac.v1alpha1.Role
		///
...
/// Codable conformance
///
public extension rbac.v1alpha1.RoleList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([rbac.v1alpha1.Role].self, forKey: .items)
	}
...
// MARK: - rbac.v1alpha1.RoleList + Sequence
