...
public extension rbac.v1alpha1 {
	...
	struct ClusterRole: KubernetesResource, KubernetesAPIResource, MetadataHavingResource, ListableResource, ClusterScopedResource {
		...
		///
		public typealias List = rbac.v1alpha1.ClusterRoleList
		///
...
extension rbac.v1alpha1.ClusterRole {
	...
	public init(from decoder: Decoder) throws {
		...
		self.aggregationRule = try container.decodeIfPresent(rbac.v1alpha1.AggregationRule.self, forKey: .aggregationRule)
