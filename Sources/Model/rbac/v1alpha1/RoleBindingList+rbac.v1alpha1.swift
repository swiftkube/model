...
public extension rbac.v1alpha1 {
	...
	struct RoleBindingList: KubernetesResource, KubernetesResourceList {
		...
		///
		public typealias Item = rbac.v1alpha1.RoleBinding
		///
...
/// Codable conformance
///
public extension rbac.v1alpha1.RoleBindingList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([rbac.v1alpha1.RoleBinding].self, forKey: .items)
	}
...
// MARK: - rbac.v1alpha1.RoleBindingList + Sequence
