...
public extension rbac.v1alpha1 {
	...
	///
	struct ClusterRoleBinding: KubernetesResource, ResourceWithMetadata {
		///
		...
		///
		public var roleRef: rbac.v1alpha1.RoleRef
		///
		/// Subjects holds references to the objects the role applies to.
		///
		public var subjects: [rbac.v1alpha1.Subject]?
		///
		...
		public init(
			...
			subjects: [rbac.v1alpha1.Subject]? = nil
		) {
