...
public extension rbac.v1alpha1 {
	...
	struct ClusterRoleBindingList: KubernetesResource, KubernetesResourceList {
		...
		///
		public typealias Item = rbac.v1alpha1.ClusterRoleBinding
		///
...
/// Codable conformance
///
public extension rbac.v1alpha1.ClusterRoleBindingList {
	...
	init(from decoder: Decoder) throws {
		...
		self.items = try container.decode([rbac.v1alpha1.ClusterRoleBinding].self, forKey: .items)
	}
...
// MARK: - rbac.v1alpha1.ClusterRoleBindingList + Sequence
